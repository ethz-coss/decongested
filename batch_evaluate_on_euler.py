...
# test
os.system(f'sbatch --mem-per-cpu=16G --gpus=1 --gres=gpumem:32g --time=04:00:00 --wrap="python dqn_grid_evaluate_online.py {N_ITER} random random {SAVE_PATH} uniform 0.5 --iot_nodes"')
